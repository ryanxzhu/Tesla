...
domready(function() {
  var deskRegion = document.querySelector(
    'section[data-title="Power Everything"] .hero-region--center-top'
  );
  var mobileRegion = document.querySelector(
    'section[data-title="Power Everything"] .hero--disclaimer-and-arrow'
  );
});
domready(function() {
  if (
  ...
  function e() {
    var e,
      ...
      n = document.querySelectorAll(
        ".hero:not(.hero--with-banner) picture img"
      );
    if (
      r.matches ||
      (t.matches &&
...
!(function(t) {
  ...
  function(t, e, n) {
    ...
    if ((!L || !S || S === A) && ((S = E.prototype), L))
      for (r in j) i[r] && p(i[r].prototype, S);
  ...
  function(t, e, n) {
    ...
    (t.exports = function(t, e, n, f, l) {
      ...
      if (l) h = t;
        ...
        if (o(p)) {
          for (d = 0, v = i(t.length); v > d; d++)
            if ((g = f ? b(r((m = t[d]))[0], m[1]) : b(t[d])) && g instanceof s)
              return g;
          return new s(!1);
        }
        h = p.call(t);
      ...
      for (y = h.next; !(m = y.call(h)).done; )
        if ("object" == typeof (g = u(h, b, m.value, f)) && g && g instanceof s)
          return g;
      return new s(!1);
    }).stop = function(t) {
      return new s(!0, t);
  ...
  function(t, e, n) {
    ...
    var r = n(2),
      ...
      B = function(t, e, n, r, o, i) {
        ...
        for (
          var u = m(c.buffer).bytes, s = a + c.byteOffset, f = r(+o), l = 0;
          l < e;
          l++
        )
          u[s + l] = f[i ? l : e - l - 1];
      ...
      (x = function(t) {
        ...
        c(E.prototype, {
          ...
          getUint32: function(t) {
            return (
              k(D(this, 4, t, arguments.length > 1 ? arguments[1] : void 0)) >>>
              0
            );
          },
    ...
    g(x, "ArrayBuffer"),
      g(E, "DataView"),
      (t.exports = { ArrayBuffer: x, DataView: E });
  },
  function(t, e, n) {
    var r = n(2),
      o = n(3),
  ...
  function(t, e, n) {
    ...
    function g(t, e) {
      ...
      for (var o = 0; o < t.length; o++)
        (t[o][r] = t[o][r] || { skipTest: e.skipTest }), v(t[o]);
      n &&
        ...
        (o.prototype.THROTTLE_TIMEOUT = 100),
          ...
          (o.prototype._computeTargetAndRootIntersection = function(n, r) {
            if ("none" != t.getComputedStyle(n).display) {
              for (
                var o, i, a, u, f, l, h, p, d = c(n), v = s(n), g = !1;
                !g;
    ...
    var r = n(0),
      ...
      ut = function(t, e) {
        ...
        if (n !== q || !s(J, r) || s(Q, r)) {
          var o = G(n, r);
          return (
            !o || !s(J, r) || (s(n, F) && n[F][r]) || (o.enumerable = !0), o
          );
        }
      },
      st = function(t) {
    ...
    r(
      { target: "Array", proto: !0, forced: !f("splice") },
      {
        splice: function(t, e) {
          ...
          for (f = u(g, r), p = 0; p < r; p++)
            (d = m + p) in g && s(f, p, g[d]);
          if (((f.length = r), n < r)) {
            for (p = m; p < y - r; p++)
          ...
          [
            ...
            function(t, o) {
              ...
              for (var w = 0, x = 0, E = []; x < h.length; ) {
                ...
                if (
                  null === A ||
                  (S = d(s(m.lastIndex + (v ? 0 : x)), h.length)) === w
                )
                  x = u(h, x, g);
                else {
  ...
  function(t, e, n) {
    ...
    var p = {
        registerComponent: function(t, e, n) {
          function r(t) {
            return (
              "initialized" === t.getAttribute("data-drupal-component-status")
            );
          }
          function o(t) {
            for (
              var e, n = document.querySelectorAll(t), o = 0, a = n.length;
              o < a;
              o++
            )
              r((e = n[o])) || i(e);
          ...
          var i = function(t) {
            t.setAttribute("data-drupal-component-status", "initialized"),
              new n(t).init();
          };
          ...
          h()(
            ...
            [
              ...
              },
              {
                ...
                value: function(e) {
                  for (
                    var n, r = e.querySelectorAll("[data-gtm-event]"), o = 0;
                    o < r.length;
                    o++
                  )
                    (n = r[o].dataset.gtmInteraction),
                      -1 !==
                        this.autoBindsClickEvtListenersArr.indexOf(
                          r[o].dataset.gtmEvent
                        ) &&
                        -1 ===
                          this.autoBindsClickEvtListenersExceptions.indexOf(
                            n
                          ) &&
        ...
        if (
          ...
          var r = [
            ...
            i = function(t, e) {
              if (((e = e || ""), !t)) return "";
              for (
                var n, i = "", a = t.split(/([&;#\?])/), c = 0, u = a.length;
                c < u;
                c++
              )
          ...
          !(function(t, e, n, r, o) {
            ...
            var i = e.getElementsByTagName(n)[0],
              a = e.createElement(n);
            (a.async = !0),
              (a.src = "//www.googletagmanager.com/gtm.js?id="
                .concat("GTM-KMG5DM")
                .concat("")),
      ...
      y = (function() {
        function t() {
          f()(this, t),
            ...
            (this.parentElement = document.body.querySelector(
              ".".concat(this.PARENT_SELECTOR)
            )),
            document.body.classList.contains(this.PARENT_SELECTOR) &&
            ...
            (this.IMAGE_SWITCH_SELECTORS = [
              ".animate-onscroll.tds-animate--fade_out"
            ]),
                ...
                if (void 0 !== t) {
                  ...
                  Array.from(e).forEach(function(t) {
                    if (
                      ...
                      ((t.currentTime = 0), t.autoplay)
                    ) {
                      var e = t.play();
                      void 0 !== e &&
                        e.then(function() {}).catch(function() {});
                    }
                  });
                }
              }
    ...
    (window.D8 = p),
      ...
      null !== navigator.userAgent.match("CriOS") &&
        document.body.classList.add("browser-is-ios-chrome"),
              ...
              if ("picture" === t.nodeName.toLowerCase()) {
                ...
                "undefined" != typeof document &&
                  ...
                  t.getAttribute("data-class") &&
                    e.classList.add(t.getAttribute("data-class")),
                  t.appendChild(e);
              }
          ...
          e.detectIe = function() {
            ...
            if ((t = o({}, { useUserAgent: !1 }, t)).useUserAgent) {
              ...
              l
                ...
                : f &&
                  (n = parseInt(i.substring(u + 5, i.indexOf(".", u)), 10));
            } else {
            ...
            if (n) {
              ...
              return o(
                {},
                e,
                { isDetected: !0, isEdge: y, isBelowEdge: v, isIe7orLower: m },
                b,
                { version: n }
              );
            }
          ...
          s()(e, [
            {
              ...
              value: function() {
                ...
                (this.triggerOpen = document.body.querySelectorAll(
                  ...
                  (this.triggerClose = this.element.querySelectorAll(
  ...
  function(e, t, o) {
    ...
    !(function(i) {
      ...
      function y(e, t, o, n) {
        ...
        if (r < i.length) {
          ...
          if (r < 1)
            ...
            if (((i.length = r--), n))
              for (; ++i[r] > 9; ) (i[r] = 0), r-- || (++e.e, i.unshift(1));
      ...
      function _(e, t, o, n) {
        ...
        if (o !== m) {
          if (o !== ~~o || o < (3 == t) || o > a)
            throw Error(3 == t ? h + "precision" : f);
          for (
            o = n - (e = new s(e)).e,
              e.c.length > ++n && y(e, o, s.RM),
              2 == t && (n = e.e + o + 1);
            e.c.length < n;
      ...
      (v.abs = function() {
        ...
        (v.div = function(e) {
          ...
          do {
            ...
            (S[b++] = d ? u : ++u),
              _[0] && d ? (_[L] = n[v] || 0) : (_ = [n[v]]);
          } while ((v++ < E || _[0] !== m) && r--);
          return (
            S[0] || 1 == b || (S.shift(), g.e--),
            b > O && y(g, s, o.RM, _[0] !== m),
            g
          );
        }),
        (v.eq = function(e) {
        ...
        (v.minus = v.sub = function(e) {
          ...
          var l = r.c.slice(),
            ...
            h = e.e;
          if (!l[0] || !d[0])
            return d[0] ? ((e.s = -a), e) : new s(l[0] ? r : 0);
          if ((c = u - h)) {
            for (
              (i = c < 0) ? ((c = -c), (n = l)) : ((h = u), (n = d)),
                n.reverse(),
                a = c;
              a--;
            ...
            for (
              o = ((i = l.length < d.length) ? l : d).length, c = a = 0;
              a < o;
              a++
            )
              if (l[a] != d[a]) {
          ...
          if (
            (i && ((n = l), (l = d), (d = n), (e.s = -e.s)),
            (a = (o = d.length) - (t = l.length)) > 0)
          )
            for (; a--; ) l[t++] = 0;
          for (a = t; o > c; ) {
            if (l[--o] < d[o]) {
      ...
      L = (function() {
        function e(e, t, o, n, i, r, s) {
          (this.successCallback = e),
            ...
            (this.endpoint = i && "" != i ? i : ""),
            (this.context =
              !r || ("production" != r && "staging" != r) ? "production" : r),
            (this.version =
              s && "" != s && -1 != s.indexOf("v") ? s : "v1.0.3"),
            (this.type = n);
        }
        function t(e) {
          for (
            var t, o = window.location.search.substring(1).split("&"), n = 0;
            n < o.length;
            n++
          )
        ...
        function e() {
          ...
          (this.LOCALE_COOKIE = t ? t.toLowerCase() : t),
            ...
            "no" === y("redirect") ||
              ...
              L.city(
                e.onVisitorLocaleLookupSuccess,
                e.onVisitorLocaleLookupFailure
              ),
            ...
            [
              {
                ...
                value: function(e) {
                  ...
                  _.eraseCookie(this.COOKIE_NAME, "tesla.com"),
                    e !== this.LOCALE_COOKIE &&
                      _.createCookie(this.COOKIE_NAME, t, 360);
                }
              },
              {
              ...
              },
              {
                ...
                value: function(t) {
                  var o = t.country.iso_code,
                    n = window.i18n.region
                      ? window.i18n.region.toUpperCase()
                      : "US",
                    i = t.subdivisions ? t.subdivisions[0].names.en : "null",
                    r = t.subdivisions ? t.subdivisions[0].iso_code : "null",
                    s =
                      !(
                        !Object.prototype.hasOwnProperty.call(t, "isStoreIP") ||
                        !t.isStoreIP
                      ) && t.isStoreIP,
              ...
              },
              {
                ...
                value: function() {
                  _.createCookie("ip-lookup-have-i-asked", "Y", 0.04),
                    (function() {
                      var e = document.getElementById("locale-modal-trigger")
                          .firstElementChild,
    ...
    var S = window.D8,
      b = (function(e) {
        function t(e) {
          ...
          return (
            i()(this, t),
            ((o = a()(this, u()(t).call(this))).TDS_MENU_MASK = e.querySelector(
              "#tds-header-mask"
            )),
            (o.TDS_MENU_CHECKBOX = e.querySelector(
              "#tds-header-main--trigger"
            )),
            (o.TDS_HEADER_CHECKBOXES = e.querySelectorAll(
              ".tds-header-checkbox"
            )),
            ...
            (o.MODAL_LOCALE = document.body.querySelector(
              ".tds-modal.modal-locale"
            )),
            (o.FIRST_TIME_SELECTOR = document.body.querySelector(
              ".first-time-selector"
            )),
                ...
                value: function() {
                  if (this.MAIN_MENU_LOCALE_SELECTOR) {
                    ...
                    var o = document.querySelector(
                      ".tds-header-nav--locale_selector > ol"
                    );
                    if (void 0 !== o) {
                  ...
                  if (this.USER_LOGIN_LINKS_SELECTOR) {
                    ...
                    if (null !== n) {
                      ...
                      for (
                        var i = 0;
                        i < this.USER_LOGIN_LINKS_SELECTOR.length;
                        i++
                      ) {
                    ...
                    if (void 0 !== s)
                      for (
                        var c = 0;
                        c < this.USER_LOGIN_LINKS_SELECTOR.length;
                        c++
                      ) {
                  ...
                  (this.MODAL_TRIGGER_OPEN = document.body.querySelectorAll(
                    ...
                    this.TDS_MENU_MASK.addEventListener(
                      "click",
                      this.tdsCloseMask.bind(this)
                    ),
                    ...
                    document.addEventListener(
                      "scroll",
                      this.tdsPageScrolling.bind(this),
                      !1
                    ),
                    ...
                    this.TDS_MENU_MASK.addEventListener(
                      "touchmove",
                      t.tdsInterceptTouchMove
                    );
                  var l = this.MODAL_LOCALE && this.MODAL_LOCALE.parentNode,
                    u =
                      this.FIRST_TIME_SELECTOR &&
                      this.FIRST_TIME_SELECTOR.parentNode;
                  l &&
              ...
              },
              {
                ...
                value: function() {
                  ...
                  for (e = 0; e < this.MODAL_TRIGGER_OPEN.length; e++) {
                    this.MODAL_TRIGGER_OPEN[e].addEventListener(
                      "click",
                      function() {
                        i.open();
                      }
                  ...
                  for (o = 0; o < this.MODAL_TRIGGER_CLOSE.length; o++) {
                    this.MODAL_TRIGGER_CLOSE[o].addEventListener(
                      "click",
                      function() {
                        i.close();
                      }
            ...
            [
              {
                ...
                value: function(e) {
                  if (e.length)
                    for (var t = 0; t < e.length; t++) e[t].checked = !1;
                }
              },
              {
                key: "hideEmptyMenu",
      ...
      O = (function(e) {
        function t(e) {
          ...
          return (
            ...
            (o.REGION_SELECTOR = e.querySelectorAll(
              ...
              value: function() {
                ...
                (this.LOCALE = new g()),
                    ...
                    lookupSuccess: function(t) {
                      (e.country = t.country.iso_code || null),
                        ...
                        e.country !== e.settingsCountry &&
                          ...
                          (null === e.RETURNING_USER ||
                            void 0 === e.RETURNING_USER) &&
                  ...
                  "CN" !== window.i18n.region &&
                    ...
                    L.city(
                      this.lookupHandler.lookupSuccess,
                      this.lookupHandler.lookupFail
                    ),
                ...
                null !== this.REGION_SELECTOR &&
                  Array.from(this.REGION_SELECTOR).forEach(function(e) {
                    var t = e.querySelector(
                      ".language-".concat(window.i18n.language)
                    );
                    null === t &&
                      (t = e.querySelector('section[class^="language-"]')),
              ...
              value: function() {
                ...
                if (
                  ...
                  var i = document.querySelectorAll(
                    ".region-item:not(.has_sublang) .region-link"
                  );
      ...
      l = (function(t) {
        ...
        function e(t) {
          ...
          return (
            ...
            (n.SHOWCASE_SCREENS = document.querySelectorAll(
              ".showcase-screen"
            )),
            n
          );
                ...
                if (
                  ...
                  if (e.classList.contains("showcase-screen--with-drawer")) {
                    ...
                    var i = e.querySelector(
                      "section.order, section.specifications"
                    );
                    if (null !== i)
...
!(function(t) {
        ...
        update: function(t, n) {
          ...
          for (t = void 0 !== t ? t : s.now(); e.length > 0; ) {
            ...
            for (var r = 0; r < e.length; r++) {
              ...
              i &&
                !1 === i.update(t) &&
                ((i._isPlaying = !1), n || delete this._tweens[e[r]]);
            }
  ...
  function(t, n, e) {
    ...
    !(function(i) {
      ...
      function m(t, n, e, r) {
        ...
        if (o < i.length) {
          if (1 === e) r = i[o] >= 5;
            ...
            r =
              i[o] > 5 ||
              (5 == i[o] && (r || o < 0 || i[o + 1] !== _ || 1 & i[o - 1]));
          else if (3 === e) r = r || !!i[0];
          else if (((r = !1), 0 !== e)) throw Error(d);
          if (o < 1)
            (i.length = 1), r ? ((t.e = -n), (i[0] = 1)) : (i[0] = t.e = 0);
          else {
            if (((i.length = o--), r))
              for (; ++i[o] > 9; ) (i[o] = 0), o-- || (++t.e, i.unshift(1));
      ...
      function y(t, n, e, r) {
        ...
        if (e !== _) {
          if (e !== ~~e || e < (3 == n) || e > a)
            throw Error(3 == n ? f + "precision" : p);
          for (
            e = r - (t = new s(t)).e,
              t.c.length > ++r && m(t, e, s.RM),
              2 == n && (r = t.e + e + 1);
            t.c.length < r;
      ...
      (v.abs = function() {
        ...
        (v.div = function(t) {
          ...
          do {
            ...
            (S[k++] = h ? l : ++l),
              y[0] && h ? (y[g] = r[v] || 0) : (y = [r[v]]);
          } while ((v++ < w || y[0] !== _) && o--);
          return (
            S[0] || 1 == k || (S.shift(), b.e--),
            k > E && m(b, s, e.RM, y[0] !== _),
            b
          );
        }),
        (v.eq = function(t) {
        ...
        (v.minus = v.sub = function(t) {
          ...
          var c = o.c.slice(),
            ...
            f = t.e;
          if (!c[0] || !h[0])
            return h[0] ? ((t.s = -a), t) : new s(c[0] ? o : 0);
          if ((u = l - f)) {
            for (
              (i = u < 0) ? ((u = -u), (r = c)) : ((f = l), (r = h)),
                r.reverse(),
                a = u;
              a--;
            ...
            for (
              e = ((i = c.length < h.length) ? c : h).length, u = a = 0;
              a < e;
              a++
            )
              if (c[a] != h[a]) {
          ...
          if (
            (i && ((r = c), (c = h), (h = r), (t.s = -t.s)),
            (a = (e = h.length) - (n = c.length)) > 0)
          )
            for (; a--; ) c[n++] = 0;
          for (a = n; e > u; ) {
            if (c[--e] < h[e]) {
        ...
        (v.plus = v.add = function(t) {
          ...
          for (
            u.length - c.length < 0 && ((n = c), (c = u), (u = n)),
              i = c.length,
              o = 0;
            i;
            u[i] %= 10
  ...
  function(t, n) {
    ...
    function f() {
      l &&
        a &&
        ((l = !1), a.length ? (c = a.concat(c)) : (h = -1), c.length && p());
    }
    function p() {
      if (!l) {
        var t = u(f);
          ...
          s()(n, [
            {
              ...
              value: function() {
                ...
                (this.showStickyNavElement = !1),
                  ...
                  null !== n &&
                    n.addEventListener("click", this.handleNavArrowClick, !0),
                  null ===
                    document.querySelector(
                      ".".concat("page_has--scroll_locking")
                  ...
                  new d.a.Tween(e)
                    ...
                    .onComplete(function() {
                      document.body.classList.add(
                        n.PAGE_HAS_FIRST_SCREEN_IN_VIEWPORT
                      );
                    })
                    .start(),
                  !1
            ...
            },
            {
              ...
              value: function() {
                ...
                0 !== t &&
                  ...
                  (this.element.style.transform = "translate(0, -".concat(
                    t,
                    "px)"
                  )));
              }
...
!(function(e) {
      ...
      function g(e, t, n, i) {
        ...
        if (o < r.length) {
          if (1 === n) i = r[o] >= 5;
            ...
            i =
              r[o] > 5 ||
              (5 == r[o] && (i || o < 0 || r[o + 1] !== y || 1 & r[o - 1]));
          else if (3 === n) i = i || !!r[0];
          else if (((i = !1), 0 !== n)) throw Error(p);
          if (o < 1)
            (r.length = 1), i ? ((e.e = -t), (r[0] = 1)) : (r[0] = e.e = 0);
          else {
            if (((r.length = o--), i))
      ...
      (m.abs = function() {
        ...
        (m.div = function(e) {
          ...
          do {
            ...
            (E[O++] = h ? l : ++l),
              w[0] && h ? (w[b] = i[m] || 0) : (w = [i[m]]);
          } while ((m++ < v || w[0] !== y) && o--);
          return (
            E[0] || 1 == O || (E.shift(), x.e--),
            O > A && g(x, s, n.RM, w[0] !== y),
            x
          );
        }),
        (m.eq = function(e) {
        ...
        (m.minus = m.sub = function(e) {
          ...
          var u = o.c.slice(),
            ...
            f = e.e;
          if (!u[0] || !h[0])
            return h[0] ? ((e.s = -c), e) : new s(u[0] ? o : 0);
          if ((a = l - f)) {
            for (
              (r = a < 0) ? ((a = -a), (i = u)) : ((f = l), (i = h)),
                i.reverse(),
                c = a;
              c--;
            ...
            for (
              n = ((r = u.length < h.length) ? u : h).length, a = c = 0;
              c < n;
              c++
            )
              if (u[c] != h[c]) {
          ...
          if (
            (r && ((i = u), (u = h), (h = i), (e.s = -e.s)),
            (c = (n = h.length) - (t = u.length)) > 0)
          )
            for (; c--; ) u[t++] = 0;
          for (c = t; n > a; ) {
            if (u[--n] < h[n]) {
        ...
        (m.plus = m.add = function(e) {
          ...
          for (
            a.length - u.length < 0 && ((t = u), (u = a), (a = t)),
              r = u.length,
              o = 0;
            r;
            a[r] %= 10
          ...
          t.detectIe = function() {
            ...
            if ((e = i({}, { useUserAgent: !1 }, e)).useUserAgent) {
              ...
              l
                ...
                : f &&
                  (n = parseInt(o.substring(u + 5, o.indexOf(".", u)), 10));
            } else {
            ...
            if (n) {
              ...
              return i(
                {},
                t,
                { isDetected: !0, isEdge: m, isBelowEdge: v, isIe7orLower: y },
                p,
                { version: n }
              );
            }
  ...
  function(e, t, n) {
    ...
    function d(e) {
      for (
        var t = e.element, n = e.className;
        (t = t.nextElementSibling) && !t.classList.contains(n);
          ...
          s()(e, [
            ...
            },
            {
              ...
              value: function(e) {
                ...
                null !== n &&
                  "" !== n &&
                  t !== n &&
                  this.element.setAttribute("poster", n);
              }
            },
            {
              ...
              value: function(e) {
                ...
                null !== n &&
                  ...
                  "true" === this.element.dataset.loaded &&
                    this.element.load());
              }
            },
            {
              ...
              value: function(e) {
                if (
                  ...
                  this.element.hasAttribute("data-autoplay-".concat(e)) &&
                    "true" ===
                      this.element.getAttribute("data-autoplay-".concat(e)))
                ) {
            ...
            },
            {
              ...
              value: function() {
                ...
                this.changeVideoSource(e),
                  this.changePosterImage(e),
                  this.changeAutoplay(e);
              }
            }
          ]),
          e
          ...
          s()(t, [
            {
              ...
              value: function() {
                ...
                (this.IS_IE = t.isDetected && t.isBelowEdge),
                  (this.bannerCopyMobile = this.element.querySelector(
                    ".banner-copy--mobile"
                  )),
                  (this.bannerCopyDesktop = this.element.querySelector(
                    ".banner-copy--desktop"
                  )),
                  ...
                  (this.hasBanner = this.element.classList.contains(
                    "hero--with-banner"
                  )),
                  (this.mobilePortraitWidth = 639),
                  (this.mobileLandscapeWidth = 839),
                  (this.MOBILE_PORTRAIT = window.matchMedia(
                    "(orientation:portrait)"
                  )),
                  (this.MOBILE_LANDSCAPE = window.matchMedia(
            ...
            },
            {
              ...
              value: function(e, t) {
                var n = 100;
                return (
                  this.MOBILE_LANDSCAPE.matches && (n -= 0.5 * n), (e * t) / n
                );
              }
            },
            {
              ...
              value: function(e) {
                if (
                  ...
                  var t = Math.max(
                    ...
                    n = window
                      .getComputedStyle(e)
                      .getPropertyValue("--initial-media-height");
                  ...
                  if (this.isLastHero(e)) {
                    ...
                    e.style.setProperty("--media-height", "".concat(c, "px"));
            ...
            },
            {
              ...
              value: function() {
                ...
                if (null !== t) {
                  if (
                    this.IS_IE &&
                    t.classList.contains("hero-arrow_down--white")
                  ) {
                    var n = x.replace(/($<svg .*)?>/, "$1 fill='white'>");
                    (n = btoa(n)),
                      (t.style.backgroundImage = "url(data:image/svg+xml;base64,".concat(
                        n,
                        ")"
                      ));
                  }
            ...
            },
            {
              ...
              value: function() {
                if (this.isIpad && this.bannerCopyMobile) {
                  var e = parseInt(
                    window.getComputedStyle(this.bannerCopyMobile).height,
                    10
                  );
            ...
            },
            {
              ...
              value: function(e) {
                ...
                if (null !== n) {
                  ...
                  if (i)
                    e ===
                      i.querySelector(":scope > div > section:first-of-type") &&
                      (t = !0);
                }
                return t;
              }
    ...
    !(function(o) {
      ...
      function b(t, e, r, n) {
        ...
        if (i < o.length) {
          ...
          if (i < 1)
            (o.length = 1), n ? ((t.e = -e), (o[0] = 1)) : (o[0] = t.e = 0);
          else {
            if (((o.length = i--), n))
      ...
      function g(t, e, r, n) {
        ...
        if (r !== m) {
          if (r !== ~~r || r < (3 == e) || r > u)
            throw Error(3 == e ? h + "precision" : p);
          for (
            r = n - (t = new s(t)).e,
              t.c.length > ++n && b(t, r, s.RM),
              2 == e && (n = t.e + r + 1);
            t.c.length < n;
      ...
      (y.abs = function() {
        ...
        (y.div = function(t) {
          ...
          do {
            ...
            (_[E++] = a ? l : ++l),
              g[0] && a ? (g[w] = n[y] || 0) : (g = [n[y]]);
          } while ((y++ < v || g[0] !== m) && i--);
          return (
            _[0] || 1 == E || (_.shift(), x.e--),
            E > M && b(x, s, r.RM, g[0] !== m),
            x
          );
        }),
        (y.eq = function(t) {
        ...
        (y.minus = y.sub = function(t) {
          ...
          var f = i.c.slice(),
            ...
            h = t.e;
          if (!f[0] || !a[0])
            return a[0] ? ((t.s = -u), t) : new s(f[0] ? i : 0);
          if ((c = l - h)) {
            for (
          ...
          if (
            (o && ((n = f), (f = a), (a = n), (t.s = -t.s)),
            (u = (r = a.length) - (e = f.length)) > 0)
          )
            for (; u--; ) f[e++] = 0;
          for (u = e; r > c; ) {
            if (f[--r] < a[r]) {
...
!(function(t) {
  ...
  function(t, e, n) {
    ...
    function p(t) {
      for (
        var e = t.element, n = t.className;
        (e = e.nextElementSibling) && !e.classList.contains(n);
        ...
        return (
          a()(t, [
              ...
              value: function(t) {
                if (
                  ...
                  this.element.hasAttribute("data-autoplay-".concat(t)) &&
                    "true" ===
                      this.element.getAttribute("data-autoplay-".concat(t)))
                ) {
            ...
            },
            {
              ...
              value: function() {
                var t = this.getDeviceType();
                this.changeVideoSource(t),
                  this.changePosterImage(t),
        ...
        function e(t) {
          ...
          return (
            ...
            ((n = c()(
              this,
              s()(e).call(this, t)
            )).video = n.element.querySelector("video")),
            n
          );
        }
        return (
...
!(function(t) {
  ...
  function(t, e, i) {
    ...
    !(function(s) {
      ...
      function v(t, e, i, n) {
        ...
        if (r < s.length) {
          if (1 === i) n = s[r] >= 5;
            ...
            n =
              s[r] > 5 ||
              (5 == s[r] && (n || r < 0 || s[r + 1] !== _ || 1 & s[r - 1]));
          else if (3 === i) n = n || !!s[0];
          else if (((n = !1), 0 !== i)) throw Error(S);
          if (r < 1)
            (s.length = 1), n ? ((t.e = -e), (s[0] = 1)) : (s[0] = t.e = 0);
          else {
            if (((s.length = r--), n))
      ...
      function T(t, e, i, n) {
        ...
        if (i !== _) {
          if (i !== ~~i || i < (3 == e) || i > l)
            throw Error(3 == e ? d + "precision" : f);
          for (
            i = n - (t = new o(t)).e,
              t.c.length > ++n && v(t, i, o.RM),
              2 == e && (n = t.e + i + 1);
            t.c.length < n;
      ...
      (I.abs = function() {
        ...
        (I.div = function(t) {
          ...
          do {
            ...
            (A[g++] = h ? u : ++u),
              T[0] && h ? (T[m] = n[I] || 0) : (T = [n[I]]);
          } while ((I++ < E || T[0] !== _) && r--);
          return (
            A[0] || 1 == g || (A.shift(), p.e--),
            g > y && v(p, o, i.RM, T[0] !== _),
            p
          );
        }),
        (I.eq = function(t) {
        ...
        (I.minus = I.sub = function(t) {
          ...
          var c = r.c.slice(),
            ...
            d = t.e;
          if (!c[0] || !h[0])
            return h[0] ? ((t.s = -l), t) : new o(c[0] ? r : 0);
          if ((a = u - d)) {
            for (
              (s = a < 0) ? ((a = -a), (n = c)) : ((d = u), (n = h)),
                n.reverse(),
                l = a;
              l--;
            ...
            for (
              i = ((s = c.length < h.length) ? c : h).length, a = l = 0;
              l < i;
              l++
            )
              if (c[l] != h[l]) {
          ...
          if (
            (s && ((n = c), (c = h), (h = n), (t.s = -t.s)),
            (l = (i = h.length) - (e = c.length)) > 0)
          )
            for (; l--; ) c[e++] = 0;
          for (l = e; i > a; ) {
            if (c[--i] < h[i]) {
        ...
        (I.plus = I.add = function(t) {
          ...
          for (
            a.length - c.length < 0 && ((e = c), (c = a), (a = e)),
              s = c.length,
              r = 0;
            s;
            a[s] %= 10
          ...
          e.detectIe = function() {
            ...
            if ((t = n({}, { useUserAgent: !1 }, t)).useUserAgent) {
              ...
              u
                ...
                : d &&
                  (i = parseInt(r.substring(c + 5, r.indexOf(".", c)), 10));
            } else {
            ...
            if (i) {
              ...
              return n(
                {},
                e,
                { isDetected: !0, isEdge: I, isBelowEdge: E, isIe7orLower: _ },
                S,
                { version: i }
              );
            }
  ...
  function(t, e, i) {
    ...
    function I(t) {
      for (
        var e = t.element, i = t.className;
        (e = e.nextElementSibling) && !e.classList.contains(i);
    ...
    function _(t) {
      for (
        var e = t.element, i = t.className;
        (e = e.parentElement) && !e.classList.contains(i);
            ...
            },
            {
              ...
              value: function(t) {
                ...
                null !== i &&
                  "" !== i &&
                  e !== i &&
                  this.element.setAttribute("poster", i);
              }
            },
            {
              key: "changeVideoSource",
      ...
      m = (function() {
        function t(e) {
          ...
          if (
            ...
            (this.SLIDES_CONTAINER = e.querySelector(
              ".mktg-carousel-slides_container"
            )),
            (this.ARRAY_OF_SLIDES = S()(
              e.querySelectorAll(".mktg-js-carousel-slide")
            )),
            (this.AMOUNT_OF_SLIDES = this.ARRAY_OF_SLIDES.length),
            (this.SLIDES_CONTAINER_WIDTH =
              this.SLIDE_WIDTH * this.AMOUNT_OF_SLIDES),
          ...
          o()(t, [
            {
              ...
              value: function() {
                if (
                  ...
                  this.ITEMS_LIST.style.setProperty(
                    "width",
                    "".concat(t, "px")
                  );
                }
              ...
              value: function() {
                ...
                if ((this.initialState(n), this.HAS_SWIPEABLE_SLIDES)) {
                  ...
                  var s,
                    ...
                    c,
                    u = this.state.active,
                    h = this.element.classList.contains(
                      "js-carousel--cross_fade"
                    );
                  this.updateSlidesPositionAndSize(),
                    this.SLIDES_CONTAINER.addEventListener(
                      "touchstart",
                      function(e) {
                    ...
                    this.SLIDES_CONTAINER.addEventListener("touchend", function(
                      e
                    ) {
                      (t.SLIDES_CONTAINER.style.transition =
                        t.TRANSITION_ANIMATION),
                ...
                if (this.ITEMS_LIST) {
                  ...
                  if (
                    ...
                    var f,
                      ...
                      g,
                      y = this.state.active;
                    this.NAVIGATION_CONTAINER.addEventListener(
                      "touchstart",
                      function(e) {
                        (t.ITEMS_LIST.style.transition = "none"),
                          ...
                          (g =
                            ...
                            parseInt(
                              window.getComputedStyle(t.ARRAY_OF_ITEMS[d])
                                .marginLeft,
                              10
                            ));
                      }
                      ...
                      this.NAVIGATION_CONTAINER.addEventListener(
                        "touchend",
                        function(e) {
                          (t.ITEMS_LIST.style.transition =
                            t.TRANSITION_ANIMATION),
                            (t.ITEM_HIGHLIGHT.style.transition =
                              t.TRANSITION_ANIMATION),
                          ...
                          (i = -1 * i.toFixed(0)),
                            ...
                            0 == i
                              ? (t.updateHighlightAndItemsPosition(),
                                t.transitionSlide(t.state.active))
                              : ((y > t.ARRAY_OF_ITEMS.length - 1 || 0 > y) &&
                                  (y = 0),
                                t.transitionSlide(y));
                        }
                      ),
                ...
                if (this.INDICATOR_DOTS) {
                  for (var R = 0; R < this.ARRAY_OF_SLIDES.length; R++)
                    O.push(this.INDICATOR_DOT);
                  (O = O.join("")), (this.INDICATOR_DOTS.innerHTML = O);
                  for (
                    var N = this.INDICATOR_DOTS.querySelectorAll(
                        ".mktg-js-carousel-indicator"
                      ),
                      b = 0;
                    b < N.length;
                    b++
                    ...
                    N[b].setAttribute("data-indicator", b),
                      N[b].addEventListener(
                        "click",
                        this.transitionSlide.bind(this, b)
                      );
                  this.INDICATOR_DOTS.querySelector(
                    '[data-indicator="0"]'
                ...
                if (
                  ...
                  w.setAttribute(
                    "class",
                    "tds--is_hidden mktg-js-carousel-live_region"
                  ),
                  e.appendChild(w),
                  (w.textContent = "Slide 1 of ".concat(
                    this.ARRAY_OF_SLIDES.length
                  )),
                  this.transitionFirstSlideOnView)
                ) {
                  ...
                  null !== D &&
                    document.addEventListener("scroll", function() {
                      !t.hasBeenViewed &&
                        ...
                        window.animation.resetChildrenVideos(
                          t.ARRAY_OF_SLIDES[0]
                        ),
                        (t.hasBeenViewed = !0));
                    });
            ...
            },
            {
              ...
              value: function() {
                ...
                for (var t = 0; t < this.ARRAY_OF_SLIDES.length; t++)
                  this.ARRAY_OF_SLIDES[t].style.minWidth = "".concat(
                    this.SLIDE_WIDTH,
                    "px"
                  );
                (this.SLIDES_CONTAINER.style.width = "".concat(
                  this.SLIDES_CONTAINER_WIDTH,
                  "px"
                )),
              ...
              value: function() {
                var t = 3,
                  ...
                  r =
                    ...
                    parseInt(
                      window.getComputedStyle(this.ARRAY_OF_ITEMS[e])
                        .marginLeft,
                      10
                    );
                if (this.ITEMS_LIST) {
                  if (
                    ...
                    0 === e &&
                      ...
                      (this.ITEMS_LIST_OFFSET = 0),
                      this.LEFT_GRADIENT &&
                        (this.LEFT_GRADIENT.style.opacity = 0)),
                    ...
                    840 > window.innerWidth &&
                      ...
                      0 < e &&
                        ...
                        (this.ITEMS_LIST_OFFSET =
                          r * e - this.ITEM_HIGHLIGHT_OFFSET),
                        (i = 0)),
                      e === this.ARRAY_OF_ITEMS.length - 1 &&
                    ...
                    if (
                      ...
                      (this.ITEM_HIGHLIGHT_OFFSET = r * e),
                        (this.ITEMS_LIST_OFFSET = 0),
                        (i = 0);
                  ...
                  this.ITEMS_LIST.style.transform = "translateX(".concat(
                    a - i,
                    "px)"
                  );
                }
              ...
              value: function(t) {
                ...
                if (!e.loaded) {
                  ...
                  var n = this.element.querySelector(
                    ".mktg-carousel-slide--active .lazyload"
                  );
                  this.observer && n && this.observer.triggerLoad(n);
                }
                if (t !== i) {
                  this.ARRAY_OF_SLIDES[i].classList.remove(
                    "mktg-carousel-slide--active"
                  ),
                    this.ARRAY_OF_SLIDES[t].classList.add(
                      "mktg-carousel-slide--active"
                    ),
                    this.HAS_SWIPEABLE_SLIDES ||
                      (this.ARRAY_OF_SLIDES[i].setAttribute(
                        "aria-hidden",
                        "true"
                      ),
                      this.ARRAY_OF_SLIDES[t].removeAttribute("aria-hidden")),
                    this.ITEMS_LIST &&
                      (this.ARRAY_OF_ITEMS[i].classList.remove(
                        "mktg-carousel-item--active"
                      ),
                      this.ARRAY_OF_ITEMS[t].classList.add(
                        "mktg-carousel-item--active"
                      )),
                    0 < this.ARRAY_OF_SLIDE_CAPTIONS.length &&
            ...
            },
            {
              ...
              value: function() {
                ...
                if (e && e.querySelector("video")) {
                  ...
                  i.addEventListener("ended", this.increment),
                    i.paused && i.load();
                } else
                  this.state.autoTransitionTimeout = setTimeout(
                    this.increment,
                    t
                  );
              }
            },
            {
              ...
              value: function() {
                this.state.autoTransitionTimeout &&
                  clearTimeout(this.state.autoTransitionTimeout),
                ...
                if (
                  ...
                  e.removeEventListener("ended", this.increment),
                    e.pause(),
                    (e.currentTime = 0);
                }
              }
              ...
              value: function() {
                ...
                this.transitionSlide(t),
                  (this.element.querySelector(
                    ...
                    .concat(t + 1, " of ")
                    .concat(this.ARRAY_OF_SLIDES.length));
              }
            },
            {
              key: "decrementSlide",
                  ...
                  ),
                  {
                    ...
                    load: function(t) {
                      if ("VIDEO" === t.tagName) {
                        ...
                        i.widthChange(),
                          i.loaded(),
                          t.hasAttribute("autoplay") && t.play();
                      }
            ...
            },
            {
              ...
              value: function() {
                ...
                (t =
                  839 >= window.innerWidth
                    ? "".concat(i.offsetHeight - 20, "px")
                    : 0),
                  (n.style.minHeight = 0),
                  (e.style.marginTop = t);
              }
        ...
        function e(t) {
          ...
          s()(this, e),
            ((i = l()(
              this,
              u()(e).call(this, t)
            )).SLIDES_CONTAINER.style.width = "100%");
          for (var n = 0; n < i.ARRAY_OF_SLIDES.length; n++)
            i.ARRAY_OF_SLIDES[n].style.minWidth = "100%";
          ...
          o()(e, [
            {
              key: "init",
              value: function() {
                this.ARRAY_OF_SLIDES[0].classList.add(
                  "mktg-carousel-slide--past"
                ),
            ...
            },
            {
              key: "initializeDrawerObserver",
              value: function() {
                A()(u()(e.prototype), "initializeDrawerObserver", this).call(
                  this
                ),
            ...
            },
            {
              ...
              value: function(t) {
                ...
                this.ARRAY_OF_SLIDES[i].classList.add(
                  "mktg-carousel-slide--past"
                ),
...
!(function(t) {
  ...
  function(t, e, i) {
    ...
    !(function(r) {
      ...
      function g(t, e, i, n) {
        ...
        if (o < r.length) {
          if (1 === i) n = r[o] >= 5;
            ...
            n =
              r[o] > 5 ||
              (5 == r[o] && (n || o < 0 || r[o + 1] !== I || 1 & r[o - 1]));
          else if (3 === i) n = n || !!r[0];
          else if (((n = !1), 0 !== i)) throw Error(m);
          if (o < 1)
            (r.length = 1), n ? ((t.e = -e), (r[0] = 1)) : (r[0] = t.e = 0);
          else {
            if (((r.length = o--), n))
              for (; ++r[o] > 9; ) (r[o] = 0), o-- || (++t.e, r.unshift(1));
            for (o = r.length; !r[--o]; ) r.pop();
          }
      ...
      function M(t, e, i, n) {
        ...
        if (i !== I) {
          if (i !== ~~i || i < (3 == e) || i > c)
            throw Error(3 == e ? u + "precision" : f);
          for (
            i = n - (t = new s(t)).e,
              t.c.length > ++n && g(t, i, s.RM),
              2 == e && (n = t.e + i + 1);
            t.c.length < n;
      ...
      (p.abs = function() {
        ...
        (p.div = function(t) {
          ...
          do {
            ...
            (y[A++] = d ? h : ++h),
              M[0] && d ? (M[v] = n[p] || 0) : (M = [n[p]]);
          } while ((p++ < P || M[0] !== I) && o--);
          return (
            y[0] || 1 == A || (y.shift(), w.e--),
            A > E && g(w, s, i.RM, M[0] !== I),
            w
          );
        }),
        (p.eq = function(t) {
        ...
        (p.minus = p.sub = function(t) {
          ...
          var l = o.c.slice(),
            ...
            u = t.e;
          if (!l[0] || !d[0])
            return d[0] ? ((t.s = -c), t) : new s(l[0] ? o : 0);
          if ((a = h - u)) {
            for (
              (r = a < 0) ? ((a = -a), (n = l)) : ((u = h), (n = d)),
                n.reverse(),
                c = a;
              c--;
            ...
            for (
              i = ((r = l.length < d.length) ? l : d).length, a = c = 0;
              c < i;
              c++
            )
              if (l[c] != d[c]) {
          ...
          if (
            (r && ((n = l), (l = d), (d = n), (t.s = -t.s)),
            (c = (i = d.length) - (e = l.length)) > 0)
          )
            for (; c--; ) l[e++] = 0;
          for (c = e; i > a; ) {
            if (l[--i] < d[i]) {
        ...
        (p.plus = p.add = function(t) {
          ...
          for (
            a.length - l.length < 0 && ((e = l), (l = a), (a = e)),
              r = l.length,
              o = 0;
            r;
            a[r] %= 10
  ...
  function(t, e, i) {
            ...
            [
              {
                ...
                value: function() {
                  ...
                  (this.isIE11 =
                    ...
                    (this.indicators = this.element.querySelectorAll(
                      ".mktg-carousel-indicator"
                    )),
                    (this.arrowDown = this.element.querySelector(
                      ".tds-icon-arrow_down"
                    )),
                  ...
                  var i = f(function() {
                    t.mainImage.style.removeProperty("width"),
                      e.calculateTransformValues(
                        t.mainImage,
                        t.indicators,
                        t.isIE11
                      ),
                      t.setMobileHeight();
                    var i = t.indicatorContainer.querySelector(
                        ".mktg-carousel-indicator--active"
                      ),
                      n = getComputedStyle(i).getPropertyValue(
              ...
              },
              {
                ...
                value: function(t) {
                  3 === g
                    ? (this.mainImage.classList.contains(
                        "transition--intro-width"
                  ...
                  for (
                    var r = function(i) {
                        ...
                        n.addEventListener("click", function() {
                          ...
                          var o = getComputedStyle(n).getPropertyValue(
                            e.TRANSFORM_PROPERTY
                          );
                          t.isIE11
                            ...
                            r ||
                              (t.headerCopy[
                                t.activeSlideIndex
                              ].classList.remove("animate--slide_to_left"),
              ...
              },
              {
                ...
                value: function() {
                  ...
                  this.introFinished ||
                    ...
                    this.mainImage.removeEventListener(
                      "transitionend",
                      function() {}
                    ));
                }
              },
              {
                ...
                value: function() {
                  this.indicatorContainer.classList.add("indicators--reveal"),
                    this.productContainer.classList.add(
                      "product-content--reveal"
                    ),
                    this.arrowDown &&
                      this.arrowDown.classList.add(
                        "tds-icon-arrow_down--reveal"
                      );
                }
              },
              {
              ...
              },
              {
                ...
                value: function(t) {
                  ...
                  if (this.introFinished) {
                    if (
                      null !== this.touchStartPositionX &&
                      null !== this.touchStartPositionY
                    )
                      Math.abs(i) > Math.abs(n) &&
                        (t.preventDefault(),
                        (this.swipeDirection = 0 < i ? "left" : "right"));
                    else if (e.MEDIA_MEDIUM_DESKTOP.matches)
                      if ((t.preventDefault(), Math.abs(r) > o - 250))
                        this.swipeDirection = "left";
                      else {
                        if (!(Math.abs(r) < 250))
                          return void (this.swipeDirection = null);
                    ...
                    (s = parseInt(s, 10)),
                      ...
                      ("right" === this.swipeDirection && this.canSwipeRight())
                        ? !0 === this.swipeLock &&
                          ((s -= i),
                          this.isIE11
                            ? ((s = this.indicators[this.activeSlideIndex]
                                .dataset.transformPannableCarousel),
                              (s -= i),
            ...
            [
              {
                ...
                value: function(t, i, n) {
                  ...
                  e.MEDIA_MOBILE_PORTRAIT.matches
                    ...
                    ? ((o = e.LOCATION_MAP.MEDIA_MOBILE_PORTRAIT),
                      4 === this.carAmount &&
                        (o = e.LOCATION_MAP.MEDIA_IPAD_PORTRAIT))
                  ...
                  for (var s = 0; s < i.length; s++) {
                    ...
                    n
                      ? (a.dataset.transformPannableCarousel = "".concat(
                          h,
                          "px"
                        ))
                      : a.style.setProperty(
    ...
    (v.MEDIA_MOBILE_PORTRAIT = window.matchMedia(
      ...
      (v.MEDIA_MOBILE_LANDSCAPE = window.matchMedia(
...
!(function(t) {
        ...
        update: function(t, e) {
          ...
          for (t = void 0 !== t ? t : a.now(); n.length > 0; ) {
            ...
            for (var o = 0; o < n.length; o++) {
              ...
              r &&
                !1 === r.update(t) &&
                ((r._isPlaying = !1), e || delete this._tweens[n[o]]);
            }
          ...
          Bezier: function(t, e) {
            for (
              var n = 0,
                o = t.length - 1,
                r = Math.pow,
                i = a.Interpolation.Utils.Bernstein,
                s = 0;
              s <= o;
              s++
            )
          ...
          e.detectIe = function() {
            ...
            if (n) {
              ...
              return o(
                {},
                e,
                { isDetected: !0, isEdge: v, isBelowEdge: w, isIe7orLower: m },
                p,
                { version: n }
              );
            }
  ...
  function(t, e, n) {
    ...
    !(function(r) {
      ...
      function g(t, e, n, o) {
        ...
        if (i < r.length) {
          if (1 === n) o = r[i] >= 5;
            ...
            o =
              r[i] > 5 ||
              (5 == r[i] && (o || i < 0 || r[i + 1] !== m || 1 & r[i - 1]));
          else if (3 === n) o = o || !!r[0];
          else if (((o = !1), 0 !== n)) throw Error(p);
          if (i < 1)
            (r.length = 1), o ? ((t.e = -e), (r[0] = 1)) : (r[0] = t.e = 0);
          else {
            if (((r.length = i--), o))
              for (; ++r[i] > 9; ) (r[i] = 0), i-- || (++t.e, r.unshift(1));
      ...
      function y(t, e, n, o) {
        ...
        if (n !== m) {
          if (n !== ~~n || n < (3 == e) || n > c)
            throw Error(3 == e ? f + "precision" : h);
          for (
            n = o - (t = new a(t)).e,
              t.c.length > ++o && g(t, n, a.RM),
              2 == e && (o = t.e + n + 1);
            t.c.length < o;
      ...
      (v.abs = function() {
        ...
        (v.div = function(t) {
          ...
          do {
            ...
            (b[S++] = d ? l : ++l),
              y[0] && d ? (y[_] = o[v] || 0) : (y = [o[v]]);
          } while ((v++ < w || y[0] !== m) && i--);
          return (
            b[0] || 1 == S || (b.shift(), E.e--),
            S > L && g(E, a, n.RM, y[0] !== m),
            E
          );
        }),
        (v.eq = function(t) {
        ...
        (v.minus = v.sub = function(t) {
          ...
          var u = i.c.slice(),
            ...
            f = t.e;
          if (!u[0] || !d[0])
            return d[0] ? ((t.s = -c), t) : new a(u[0] ? i : 0);
          if ((s = l - f)) {
            for (
              (r = s < 0) ? ((s = -s), (o = u)) : ((f = l), (o = d)),
                o.reverse(),
                c = s;
              c--;
            ...
            for (
              n = ((r = u.length < d.length) ? u : d).length, s = c = 0;
              c < n;
              c++
            )
              if (u[c] != d[c]) {
          ...
          if (
            (r && ((o = u), (u = d), (d = o), (t.s = -t.s)),
            (c = (n = d.length) - (e = u.length)) > 0)
          )
            for (; c--; ) u[e++] = 0;
          for (c = e; n > s; ) {
            if (u[--n] < d[n]) {
        ...
        (v.plus = v.add = function(t) {
          ...
          for (
            s.length - u.length < 0 && ((e = u), (u = s), (s = e)),
              r = u.length,
              i = 0;
            r;
            s[r] %= 10
      ...
      updateOnlyOwnProperties: function() {
        if ("undefined" != typeof window) {
          (c.passiveEvents = c.state.detectPassiveEvents.hasSupport || !1),
            ...
            (c.primaryInput =
              ("mouseOnly" === c.deviceType
                ? "mouse"
                : "touchOnly" === c.deviceType && "touch") ||
  ...
  function(t, e, n) {
    ...
    var o = {
      update: function() {
        "undefined" != typeof window &&
          ((o.hasSupport = "ontouchstart" in window),
          (o.browserSupportsApi = Boolean(window.TouchEvent)));
      }
    };
    o.update(), (e.default = o);
  },
  ...
  function(t, e, n) {
    ...
    var p,
      ...
      W = (function() {
        for (
          ...
          window.requestAnimationFrame =
            window["".concat(e[s], "RequestAnimationFrame")];
        window.requestAnimationFrame ||
      ...
      Q =
        ...
        (g.on = function(t) {
          _ || (B(document), (_ = !0)),
            -1 !== y.indexOf(t) || (y.push(t), (p = y.length));
        }),
        ...
        (g.off = function(t) {
          var e = y.indexOf(t);
          -1 === e ||
            (y.splice(e, 1), 0 >= (p = y.length) && (G(document), (_ = !1)));
        }),
    ...
    function Dt(t) {
      if (
        !tt &&
        ((tt = document.querySelector(".".concat(kt))),
        (et = tt.querySelectorAll(".".concat(jt))),
        !nt)
      ) {
        var e = et,
          n = lt()(e, 1);
      ...
      if (
        ...
        (function(t) {
          ...
          Ht()(e).forEach(function(e) {
            e.endsWith("_static_nav") &&
              !e.endsWith("_drawer_static_nav") &&
              t.classList.remove(e);
          });
        })(e),
          n === ft
                ...
                value: function() {
                  ...
                  e.observeStore(
                    ...
                    this.MOBILE_MEDIA_QUERY.matches
                      ? (window.addEventListener(
                          "scroll",
                          window.animation.toggleAnimationClassOnScroll.bind(
                            window.animation
                          ),
                          !1
                        ),
                      ...
                      : (this.scroll.lock(!0),
                        this.pageParentElement.classList.add(
                          this.PAGE_HAS_SCROLL_LOCKING_CLASS
                        ),
                ...
                value: function(t) {
                  if (this.MOBILE_MEDIA_QUERY.matches)
                    ...
                    t.screenIndex === this.totalScreens - 1
                      ? (Q.on(o), W.on(r))
                      : (Q.off(o), W.off(r)),
                      window.animation.resetAnimations(
                        this.screens[this.screenIndex]
                      );
                  }
                }
              },
                  ...
                  if (t && !this.MOBILE_MEDIA_QUERY.matches) {
                    ...
                    if (n) {
                      var o = n.querySelector(
                        ":scope > div > section:first-of-type"
                      );
                      o &&
                        o.style.setProperty(
                          "--media-height",
    ...
    function ie(t) {
      var e =
          1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : null,
        n =
          2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : 950,
        o =
      ...
      !(function(t, e) {
        ...
        new z.a.Tween(t)
          ...
          .onUpdate(function() {
            r &&
              r.classList.contains(At) &&
              window.scrollTo(this._object.x, this._object.y);
          })
          .onComplete(function() {
            n && n();
          })
    ...
    function Qe() {
      ...
      if (t.isDetected && t.isBelowEdge)
        if (je.classList.contains("close_button--white"))
          !(function() {
            var t = document.querySelector(
              "#drawer-navigation .tds-icon-wordmark--inverted"
            );
            t &&
              (t.classList.remove("tds-icon-wordmark--inverted"),
              t.classList.add("tds-icon-wordmark"));
            ...
            e.forEach(function(t, r) {
              ...
              t.classList.contains("tds-icon-chevron_down")
                ...
                i &&
                  ((e[
                    r
                  ].style.backgroundImage = "url(data:image/svg+xml;base64,".concat(
                    i,
                    ")"
                  )),
          ...
          var e = document.querySelector(
            "#drawer-navigation .tds-icon-wordmark"
          );
          e &&
            (e.classList.remove("tds-icon-wordmark"),
            e.classList.add("tds-icon-wordmark--inverted"));
        }
      Ge(),
        St.matches ||
          (re({
      ...
      if (De) {
        ...
        var o = zt(t).top,
          r =
            (function() {
              for (
                var t = 0, e = document.querySelectorAll(".".concat(ve));
                e.length;
                t++
              ) {
        ...
        Re
          ...
          : (window.pageYOffset < o &&
              (Xt.sync(), Xt.setCurrent(Xt.current + r)),
    ...
    function Ke(t) {
      var e = re({ element: t, className: ve }),
        n = null;
      if (
        (null !== e && (n = e.querySelector(".".concat(ye))),
        n && n.classList.contains(ye))
      ) {
        var o = n;
        t.addEventListener("click", function(n) {
          if (
            (n.preventDefault(),
            !St.matches || !t.hasAttribute("data-modal-open"))
          ) {
          ...
          on.addEventListener("click", function(t) {
            !(function(t) {
              document.querySelector(".".concat(At))
                ...
                : t.target &&
                  t.target.matches(".".concat(jt)) &&
                  sn(t.target.dataset.title);
            })(t);
          });
      }
    }
    function un(t) {
      ...
      if (
        (t.preventDefault(),
        null === document.querySelector(".".concat(It)) || St.matches)
      ) {
    ...
    var dn = (function() {
      ...
      fn = document
        .querySelector("body")
        .classList.contains("page_has--parallax"),
      hn = function(t) {
      ...
      vn = (function(t) {
        function e(t) {
          ...
          return (
            ...
            ((n = c()(this, l()(e).call(this))).MOBILE_MEDIA_QUERY = St),
            (n.element = t),
            (n.TOGGLE_ON_SCROLL_TOP_ELEMENTS = document.querySelectorAll(
          ...
          a()(e, [
            {
              ...
              value: function() {
                ...
                var o = (function(t, e) {
                    ...
                    this.TOGGLE_ON_SCROLL_TOP_ELEMENTS,
                    this.TOGGLE_ON_SCROLL_TOP_CLASS
                  ),
                  r = (function() {
                    var t = !1,
                    ...
                    return function() {
                      ...
                      if (n && n.classList.contains(At))
                        ...
                        t &&
                          o &&
                          r &&
                          window.animation.removeClassOnScrollStep(r),
                          (t = !1);
                      }
                    };
                  })();
                            ...
                            window.innerHeight
                              ...
                              : (t < window.innerHeight
                                  ? ((je.style.top = "auto"),
                                    ...
                                    ((!Ue &&
                                      0 >= qe.getBoundingClientRect().top) ||
                                      (Ue &&
                                        0 < qe.getBoundingClientRect().top)) &&
                                      en())
                                  : t >= window.innerHeight &&
...
(function(i, e) {
  ...
  a.onload = function() {
    ...
    e.TeslaTwilio.parseInitializer = function(i) {
      ...
      i.strings.MessageCanvasTrayButton =
        e.TeslaTwilio.initializer.MessageCanvasTrayButton;
      i.strings.InvalidPreEngagementMessage =
        e.TeslaTwilio.initializer.InvalidPreEngagementMessage;
      i.strings.InvalidPreEngagementButton =
        e.TeslaTwilio.initializer.InvalidPreEngagementButton;
      i.strings.PredefinedChatMessageAuthorName =
        e.TeslaTwilio.initializer.PredefinedChatMessageAuthorName;
      i.strings.PredefinedChatMessageBody =
        e.TeslaTwilio.initializer.PredefinedChatMessageBody;
      i.strings.InputPlaceHolder = e.TeslaTwilio.initializer.InputPlaceHolder;
      i.strings.Read = e.TeslaTwilio.initializer.Read;
      i.strings.MessageSendingDisabled =
        e.TeslaTwilio.initializer.MessageSendingDisabled;
      ...
      i.strings.MessageCharacterCountStatus =
        e.TeslaTwilio.initializer.MessageCharacterCountStatus;
      i.strings.SendMessageTooltip =
        e.TeslaTwilio.initializer.SendMessageTooltip;
      i.strings.FieldValidationRequiredField =
        e.TeslaTwilio.initializer.FieldValidationRequiredField;
      i.strings.FieldValidationInvalidEmail =
        e.TeslaTwilio.initializer.FieldValidationInvalidEmail;
      i.strings.MessageCanvasTrayContent =
        e.TeslaTwilio.initializer.MessageCanvasTrayContent;
    };
    e.Twilio.FlexWebChat.MainHeader.defaultProps.titleText = "Chat";
    e.Twilio.FlexWebChat.MainHeader.defaultProps.showImage = !1;
    var a =
      e.TeslaTwilio.initializer.AutomatedMessageBody &&
      e.TeslaTwilio.initializer.AutomatedMessageBody.length > 0;
    if (a) {
      e.Twilio.FlexWebChat.MessagingCanvas.defaultProps.predefinedMessage = !1;
    }
    e.Twilio.FlexWebChat.createWebChat(e.TeslaTwilio.configuration).then(
      function(t) {
        var n = t.manager;
        ...
        if (s.childElementCount > 1) {
          i.getElementsByTagName("body")[0].classList.add(
            "page_has--open_modal"
          );
        }
            ...
            e.map(function(e) {
              if (e.type === "childList") {
                if (s.childElementCount > 1) {
                  ...
                  i.getElementsByTagName("body")[0].classList.remove(
                    "page_has--open_modal"
                  );
                }
              }
        ...
        setTimeout(function() {
          if (
            d &&
            typeof l.getElementsByClassName("Twilio-MainContainer")[0] ===
              "undefined"
          ) {
  ...
  a.src =
    "https://media.twiliocdn.com/sdk/js/flex-webchat/releases/2.1.2/twilio-flex-webchat.min.js";
          ...
          if (n.response.success && n.response.appconfigChatTool) {
            ...
            l.addEventListener("click", function() {
              if (Twilio && Twilio.FlexWebChat) {
                ...
                Twilio.FlexWebChat.Actions.invokeAction(
            ...
            if (e.dataLayer) {
              ...
              i.getElementsByTagName("body")[0].addEventListener(
                "click",
                function(i) {
                  if (
                    typeof i !== "undefined" &&
